...
namespace datastructuresalgorithmstest
{
    ...
    public class DoubleEndedLinkedListTest
    {
        ...
        /**
         * Asserts that exception is thrown if PeakBack is called on
         * an empty list
         */
        [Test()]
        public void PeakBackThrowsIfCalledOnEmptyList()
        {
            var list = new DoubleEndedLinkedList<int>();
            Assert.Throws<IndexOutOfRangeException>(() => list.PeakBack());
        }
